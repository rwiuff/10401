...
So by first measuring the phase of the probing beam in vacuum, one can simply measure the phase shift and find the density according to \todo[inline]{Write results and finish this}
...
\begin{align}
	\qq*{\SI{60}{\giga\hertz}}  & : \quad w(z)=0.0275\sqrt{\pqty{1+\frac{9.542690316\times10^7 z}{0.0275^2 \ 60\times10^9}}^2}\label{60}   \\
	\qq*{\SI{98}{\giga\hertz}}  & : \quad w(z)=0.0275\sqrt{\pqty{1+\frac{9.542690316\times10^7 z}{0.0275^2 \ 98\times10^9}}^2}\label{98}   \\
	\qq*{\SI{130}{\giga\hertz}} & : \quad w(z)=0.0275\sqrt{\pqty{1+\frac{9.542690316\times10^7 z}{0.0275^2 \ 130\times10^9}}^2}\label{130}
\end{align}
For the three given sources in this project, the beam waist has been plotted on \cref{BeamProp}.
\begin{figure}
	\centering
	\includegraphics[width=.4\textwidth]{Figures/BeamProp.eps}
...
\begin{figure}
	...
	\label{AWESOME}
\end{figure}
\todo[inline]{Write section about interferometer considerations}
