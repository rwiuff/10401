	...
	\begin{center}
		...
		\begin{columns}[c]
			...
			\begin{description}[Goal \# 1]
				...
				\item[Goal \# 1] Determine plasma constituents, measure spectral line widths and process the data
				\item[Goal \# 2] Calculate neutron production rates as a function of voltage and current
			\end{description}
		\end{columns}
	\end{center}
\end{frame}
