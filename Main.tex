...
\begin{abstract}
	...
	\begin{description}
		\item[Abstract] Plasma fusion for energy production is growing scientific field with interest all over the globe as clean and sustainable energy as well as growing energy demands need to be adressed. In the course 10401: Fusion energy and plasma physics we deal with some of the fundamental engineering aspects of a commercial fusion energy power plant as well as the research towards this goal. In this paper we first adress a simple model for such plant and how the model can be improved. Secondly we investigate how to diagnose plasma density with simple interferometry in the DTU reactor. Lastly we made measurements on a fusor and investigate some energy production aspects with such a device. \vspace{3\baselineskip}
	\end{description}
